...
namespace EventStore.ClientAPI.Messages
{
  ...
  public partial class SubscribeToStreamFiltered
  {
    ...
    [ProtoMember(4, IsRequired = true, Name=@"send_checkpoint_message_count", DataFormat = DataFormat.TwosComplement)]
    public readonly int SendCheckpointMessageCount;
  
    private SubscribeToStreamFiltered() {}
  
    public SubscribeToStreamFiltered(string eventStreamId, bool resolveLinkTos, Filter filter, int sendCheckpointMessageCount)
    {
        EventStreamId = eventStreamId;
        ResolveLinkTos = resolveLinkTos;
        Filter = filter;
